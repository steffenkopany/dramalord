...
namespace Dramalord.Data.Intentions
{
    internal class GossipIntercourseIntention : Intention
    {
        ...
        public override bool Action()
        {
            ...
            {
                if (target.CanBeJealousAboutIntimacy(EventIntention.IntentionHero, EventIntention.Target) || target.CanBeJealousAboutIntimacy(EventIntention.Target, EventIntention.IntentionHero))
                {
                    Targets.Add(target);
