...
namespace Dramalord
{
    internal sealed class DramalordMCM : AttributeGlobalSettings<DramalordMCM>
    {
        ...
        public int MinDatingLove { get; set; } = 40;
        ...
        public int MinMarriageLove { get; set; } = 80;
        ...
        public int LoveDecayStartDay { get; set; } = 21;

        [SettingPropertyGroup(DramalordTexts.MCM_HERO)]
        [SettingPropertyFloatingInteger(DramalordTexts.MCM_HERO_MAX_CHILDREN, 0, 10, Order = 11, HintText = DramalordTexts.MCM_HERO_MAX_CHILDREN_INFO, RequireRestart = false)]
        public int MaxChildren { get; set; } = 3; 
        ...
        public bool RelationshipLogs { get; set; } = true;
        ...
        public bool TalkLogs { get; set; } = true;
        ...
        public bool GossipLogs { get; set; } = true;
        ...
        public bool FlirtingLogs { get; set; } = true;
        ...
        public bool DatingLogs { get; set; } = true;
        ...
        public bool SexLogs { get; set; } = true;
        ...
        public bool ConceiveLogs { get; set; } = true;
        ...
        public bool ChildrenEventLogs { get; set; } = true;
        ...
        public int ChanceGettingCaught { get; set; } = 50;
        ...
        [SettingPropertyGroup(DramalordTexts.MCM_GENERAL)]
        [SettingPropertyBool(DramalordTexts.MCM_GENERAL_STRICT_SEPARATION, HintText = DramalordTexts.MCM_GENERAL_STRICT_SEPARATION_INFO, Order = 11, RequireRestart = false)]
        public bool StrictTierSeparation { get; set; } = false;

        [SettingPropertyGroup(DramalordTexts.MCM_GENERAL)]
        [SettingPropertyBool(DramalordTexts.MCM_GENERAL_ALLOW_ORPHANAGE, HintText = DramalordTexts.MCM_GENERAL_ALLOW_ORPHANAGE_INFO, Order = 12, RequireRestart = false)]
        public bool AllowOrphanage { get; set; } = true;

        [SettingPropertyGroup(DramalordTexts.MCM_GENERAL)]
        [SettingPropertyBool(DramalordTexts.MCM_GENERAL_ALLOW_CAPTIVITY_SEX, HintText = DramalordTexts.MCM_GENERAL_ALLOW_CAPTIVITY_SEX_INFO, Order = 13, RequireRestart = false)]
        public bool AllowCaptivitySex { get; set; } = true;
        ...
        private bool _showHotScenes = true;
        private bool _showHotButter = false;

        [SettingPropertyGroup(DramalordTexts.MCM_OPTIONAL)]
        [SettingPropertyBool(DramalordTexts.MCM_OPTIONAL_SHOW_HOTSCENES, Order = 3, HintText = DramalordTexts.MCM_OPTIONAL_SHOW_HOTSCENES_INFO, RequireRestart = false)]
        public bool ShowHotScenes
        {
            get => _showHotScenes;
            set
            {
                _showHotScenes = value;
                if (value)
                {
                    _showHotButter = false;
                    OnPropertyChanged();
                }
            }
        }
        ...
        [SettingPropertyGroup(DramalordTexts.MCM_OPTIONAL)]
        [SettingPropertyBool(DramalordTexts.MCM_OPTIONAL_SHOW_HOTBUTTER, Order = 4, HintText = DramalordTexts.MCM_OPTIONAL_SHOW_HOTBUTTER_INFO, RequireRestart = false)]
        public bool ShowHotButter
        {
            get => _showHotButter;
            set
            {
                _showHotButter = value;
                if (value)
                {
                    _showHotScenes = false;
                    OnPropertyChanged();
                }
            }
        }
        ...
        [SettingPropertyGroup(DramalordTexts.MCM_OPTIONAL)]
        [SettingPropertyBool(DramalordTexts.MCM_OPTIONAL_SHOW_DRAMALORD_VIDEOS, Order = 5, HintText = DramalordTexts.MCM_OPTIONAL_SHOW_DRAMALORD_VIDEOS_INFO, RequireRestart = false)]
        public bool ShowDramaVideos { get; set; } = true;

        [SettingPropertyGroup(DramalordTexts.MCM_OPTIONAL)]
        [SettingPropertyBool(DramalordTexts.MCM_OPTIONAL_SHOW_DRAMALORD_IMAGES, Order = 6, HintText = DramalordTexts.MCM_OPTIONAL_SHOW_DRAMALORD_IMAGES_INFO, RequireRestart = false)]
