...
namespace cscodec.h264.decoder
{
	public class MpegEncContext
	{
		...
		public const int VP_START = 1;          ///< current MB is the first after a resync marker
		...
		public const int FF_BUFFER_TYPE_SHARED = 4; ///< Buffer from somewhere else; don't deallocate image (data/base), all other tables are not shared.
		public const int FF_BUFFER_TYPE_COPY = 8; ///< Just a (modified) copy of some other buffer, don't deallocate anything.
		...
		*/
		...
		public const int CODEC_FLAG_4MV = 0x0004;  ///< 4 MV per MB allowed / advanced prediction for H.263.
		...
		public const int CODEC_FLAG_EXTERN_HUFF = 0x01000;   ///< Use external Huffman table (for MJPEG).
		public const int CODEC_FLAG_GRAY = 0x02000;   ///< Only decode/encode grayscale.
		public const int CODEC_FLAG_EMU_EDGE = 0x04000;   ///< Don't draw edges.
		public const int CODEC_FLAG_PSNR = 0x08000;   ///< error[?] variables will be set during encoding.
		...
		public const int CODEC_FLAG_AC_PRED = 0x01000000; ///< H.263 advanced intra coding / MPEG-4 AC prediction
		...
		public const int CODEC_FLAG_H263P_AIV = 0x00000008; ///< H.263 alternative inter VLC
		...
		public const int CODEC_FLAG2_MIXED_REFS = 0x00000040; ///< H.264 one reference per partition, as opposed to one reference per macroblock
		...
		public const int CODEC_FLAG2_MBTREE = 0x00040000; ///< Use macroblock tree ratecontrol (x264 only)
		public const int CODEC_FLAG2_PSY = 0x00080000; ///< Use psycho visual optimizations.
		public const int CODEC_FLAG2_SSIM = 0x00100000; ///< Compute SSIM during encoding, error[] values are undefined.
		public const int CODEC_FLAG2_INTRA_REFRESH = 0x00200000; ///< Use periodic insertion of intra blocks instead of keyframes.
		...
		public const int AVDISCARD_NONE = -16; ///< discard nothing
		public const int AVDISCARD_DEFAULT = 0; ///< discard useless packets like 0 size packets in avi
		public const int AVDISCARD_NONREF = 8; ///< discard all non reference
		public const int AVDISCARD_BIDIR = 16; ///< discard all bidirectional frames
		public const int AVDISCARD_NONKEY = 32; ///< discard all frames except keyframes
		public const int AVDISCARD_ALL = 48; ///< discard all
		//};

		public const int AVCOL_RANGE_UNSPECIFIED = 0;
		public const int AVCOL_RANGE_MPEG = 1; ///< the normal 219*2^(n-8) "MPEG" YUV ranges
		public const int AVCOL_RANGE_JPEG = 2; ///< the normal     2^n-1   "JPEG" YUV ranges
		public const int AVCOL_RANGE_NB = 3; ///< Not part of ABI
		...
		public const int PIX_FMT_YUV420P = 1;   ///< planar YUV 4:2:0 = 0; 12bpp = 0; (1 Cr & Cb sample per 2x2 Y samples)
		public const int PIX_FMT_YUYV422 = 2;   ///< packed YUV 4:2:2 = 0; 16bpp = 0; Y0 Cb Y1 Cr
		public const int PIX_FMT_RGB24 = 3;     ///< packed RGB 8:8:8 = 0; 24bpp = 0; RGBRGB...
		public const int PIX_FMT_BGR24 = 4;     ///< packed RGB 8:8:8 = 0; 24bpp = 0; BGRBGR...
		public const int PIX_FMT_YUV422P = 5;   ///< planar YUV 4:2:2 = 0; 16bpp = 0; (1 Cr & Cb sample per 2x1 Y samples)
		public const int PIX_FMT_YUV444P = 6;   ///< planar YUV 4:4:4 = 0; 24bpp = 0; (1 Cr & Cb sample per 1x1 Y samples)
		public const int PIX_FMT_YUV410P = 7;   ///< planar YUV 4:1:0 = 0;  9bpp = 0; (1 Cr & Cb sample per 4x4 Y samples)
		public const int PIX_FMT_YUV411P = 8;   ///< planar YUV 4:1:1 = 0; 12bpp = 0; (1 Cr & Cb sample per 4x1 Y samples)
		public const int PIX_FMT_GRAY8 = 9;     ///<        Y         = 0;  8bpp
		public const int PIX_FMT_MONOWHITE = 10; ///<        Y         = 0;  1bpp = 0; 0 is white = 0; 1 is black = 0; in each byte pixels are ordered from the msb to the lsb
		public const int PIX_FMT_MONOBLACK = 11; ///<        Y         = 0;  1bpp = 0; 0 is black = 0; 1 is white = 0; in each byte pixels are ordered from the msb to the lsb
		public const int PIX_FMT_PAL8 = 12;      ///< 8 bit with public const int PIX_FMT_RGB32 palette
		public const int PIX_FMT_YUVJ420P = 13;  ///< planar YUV 4:2:0 = 0; 12bpp = 0; full scale (JPEG) = 0; deprecated in favor of public const int PIX_FMT_YUV420P and setting color_range
		public const int PIX_FMT_YUVJ422P = 14;  ///< planar YUV 4:2:2 = 0; 16bpp = 0; full scale (JPEG) = 0; deprecated in favor of public const int PIX_FMT_YUV422P and setting color_range
		public const int PIX_FMT_YUVJ444P = 15;  ///< planar YUV 4:4:4 = 0; 24bpp = 0; full scale (JPEG) = 0; deprecated in favor of public const int PIX_FMT_YUV444P and setting color_range
		public const int PIX_FMT_XVMC_MPEG2_MC = 16;///< XVideo Motion Acceleration via common packet passing
		public const int PIX_FMT_XVMC_MPEG2_IDCT = 17;
		public const int PIX_FMT_UYVY422 = 18;   ///< packed YUV 4:2:2 = 0; 16bpp = 0; Cb Y0 Cr Y1
		public const int PIX_FMT_UYYVYY411 = 19; ///< packed YUV 4:1:1 = 0; 12bpp = 0; Cb Y0 Y1 Cr Y2 Y3
		public const int PIX_FMT_BGR8 = 20;      ///< packed RGB 3:3:2 = 0;  8bpp = 0; (msb)2B 3G 3R(lsb)
		public const int PIX_FMT_BGR4 = 21;      ///< packed RGB 1:2:1 bitstream = 0;  4bpp = 0; (msb)1B 2G 1R(lsb) = 0; a byte contains two pixels = 0; the first pixel in the byte is the one composed by the 4 msb bits
		public const int PIX_FMT_BGR4_BYTE = 22; ///< packed RGB 1:2:1 = 0;  8bpp = 0; (msb)1B 2G 1R(lsb)
		public const int PIX_FMT_RGB8 = 23;      ///< packed RGB 3:3:2 = 0;  8bpp = 0; (msb)2R 3G 3B(lsb)
		public const int PIX_FMT_RGB4 = 24;      ///< packed RGB 1:2:1 bitstream = 0;  4bpp = 0; (msb)1R 2G 1B(lsb) = 0; a byte contains two pixels = 0; the first pixel in the byte is the one composed by the 4 msb bits
		public const int PIX_FMT_RGB4_BYTE = 25; ///< packed RGB 1:2:1 = 0;  8bpp = 0; (msb)1R 2G 1B(lsb)
		public const int PIX_FMT_NV12 = 26;      ///< planar YUV 4:2:0 = 0; 12bpp = 0; 1 plane for Y and 1 plane for the UV components = 0; which are interleaved (first byte U and the following byte V)
		public const int PIX_FMT_NV21 = 27;      ///< as above = 0; but U and V bytes are swapped

		public const int PIX_FMT_ARGB = 28;      ///< packed ARGB 8:8:8:8 = 0; 32bpp = 0; ARGBARGB...
		public const int PIX_FMT_RGBA = 29;      ///< packed RGBA 8:8:8:8 = 0; 32bpp = 0; RGBARGBA...
		public const int PIX_FMT_ABGR = 30;      ///< packed ABGR 8:8:8:8 = 0; 32bpp = 0; ABGRABGR...
		public const int PIX_FMT_BGRA = 31;      ///< packed BGRA 8:8:8:8 = 0; 32bpp = 0; BGRABGRA...

		public const int PIX_FMT_GRAY16BE = 32;  ///<        Y         = 0; 16bpp = 0; big-endian
		public const int PIX_FMT_GRAY16LE = 33;  ///<        Y         = 0; 16bpp = 0; little-endian
		public const int PIX_FMT_YUV440P = 34;   ///< planar YUV 4:4:0 (1 Cr & Cb sample per 1x2 Y samples)
		public const int PIX_FMT_YUVJ440P = 35;  ///< planar YUV 4:4:0 full scale (JPEG) = 0; deprecated in favor of public const int PIX_FMT_YUV440P and setting color_range
		public const int PIX_FMT_YUVA420P = 36;  ///< planar YUV 4:2:0 = 0; 20bpp = 0; (1 Cr & Cb sample per 2x2 Y & A samples)
		public const int PIX_FMT_VDPAU_H264 = 37;///< H.264 HW decoding with VDPAU = 0; data[0] contains a vdpau_render_state struct which contains the bitstream of the slices as well as various fields extracted from headers
		public const int PIX_FMT_VDPAU_MPEG1 = 38;///< MPEG-1 HW decoding with VDPAU = 0; data[0] contains a vdpau_render_state struct which contains the bitstream of the slices as well as various fields extracted from headers
		public const int PIX_FMT_VDPAU_MPEG2 = 39;///< MPEG-2 HW decoding with VDPAU = 0; data[0] contains a vdpau_render_state struct which contains the bitstream of the slices as well as various fields extracted from headers
		public const int PIX_FMT_VDPAU_WMV3 = 40;///< WMV3 HW decoding with VDPAU = 0; data[0] contains a vdpau_render_state struct which contains the bitstream of the slices as well as various fields extracted from headers
		public const int PIX_FMT_VDPAU_VC1 = 41; ///< VC-1 HW decoding with VDPAU = 0; data[0] contains a vdpau_render_state struct which contains the bitstream of the slices as well as various fields extracted from headers
		public const int PIX_FMT_RGB48BE = 42;   ///< packed RGB 16:16:16 = 0; 48bpp = 0; 16R = 0; 16G = 0; 16B = 0; the 2-byte value for each R/G/B component is stored as big-endian
		public const int PIX_FMT_RGB48LE = 43;   ///< packed RGB 16:16:16 = 0; 48bpp = 0; 16R = 0; 16G = 0; 16B = 0; the 2-byte value for each R/G/B component is stored as little-endian

		public const int PIX_FMT_RGB565BE = 44;  ///< packed RGB 5:6:5 = 0; 16bpp = 0; (msb)   5R 6G 5B(lsb) = 0; big-endian
		public const int PIX_FMT_RGB565LE = 45;  ///< packed RGB 5:6:5 = 0; 16bpp = 0; (msb)   5R 6G 5B(lsb) = 0; little-endian
		public const int PIX_FMT_RGB555BE = 46;  ///< packed RGB 5:5:5 = 0; 16bpp = 0; (msb)1A 5R 5G 5B(lsb) = 0; big-endian = 0; most significant bit to 0
		public const int PIX_FMT_RGB555LE = 47;  ///< packed RGB 5:5:5 = 0; 16bpp = 0; (msb)1A 5R 5G 5B(lsb) = 0; little-endian = 0; most significant bit to 0

		public const int PIX_FMT_BGR565BE = 48;  ///< packed BGR 5:6:5 = 0; 16bpp = 0; (msb)   5B 6G 5R(lsb) = 0; big-endian
		public const int PIX_FMT_BGR565LE = 49;  ///< packed BGR 5:6:5 = 0; 16bpp = 0; (msb)   5B 6G 5R(lsb) = 0; little-endian
		public const int PIX_FMT_BGR555BE = 50;  ///< packed BGR 5:5:5 = 0; 16bpp = 0; (msb)1A 5B 5G 5R(lsb) = 0; big-endian = 0; most significant bit to 1
		public const int PIX_FMT_BGR555LE = 51;  ///< packed BGR 5:5:5 = 0; 16bpp = 0; (msb)1A 5B 5G 5R(lsb) = 0; little-endian = 0; most significant bit to 1

		public const int PIX_FMT_VAAPI_MOCO = 52; ///< HW acceleration through VA API at motion compensation entry-point = 0; Picture.data[3] contains a vaapi_render_state struct which contains macroblocks as well as various fields extracted from headers
		public const int PIX_FMT_VAAPI_IDCT = 53; ///< HW acceleration through VA API at IDCT entry-point = 0; Picture.data[3] contains a vaapi_render_state struct which contains fields extracted from headers
		public const int PIX_FMT_VAAPI_VLD = 54;  ///< HW decoding through VA API = 0; Picture.data[3] contains a vaapi_render_state struct which contains the bitstream of the slices as well as various fields extracted from headers

		public const int PIX_FMT_YUV420P16LE = 55;  ///< planar YUV 4:2:0 = 0; 24bpp = 0; (1 Cr & Cb sample per 2x2 Y samples) = 0; little-endian
		public const int PIX_FMT_YUV420P16BE = 56;  ///< planar YUV 4:2:0 = 0; 24bpp = 0; (1 Cr & Cb sample per 2x2 Y samples) = 0; big-endian
		public const int PIX_FMT_YUV422P16LE = 57;  ///< planar YUV 4:2:2 = 0; 32bpp = 0; (1 Cr & Cb sample per 2x1 Y samples) = 0; little-endian
		public const int PIX_FMT_YUV422P16BE = 58;  ///< planar YUV 4:2:2 = 0; 32bpp = 0; (1 Cr & Cb sample per 2x1 Y samples) = 0; big-endian
		public const int PIX_FMT_YUV444P16LE = 59;  ///< planar YUV 4:4:4 = 0; 48bpp = 0; (1 Cr & Cb sample per 1x1 Y samples) = 0; little-endian
		public const int PIX_FMT_YUV444P16BE = 60;  ///< planar YUV 4:4:4 = 0; 48bpp = 0; (1 Cr & Cb sample per 1x1 Y samples) = 0; big-endian
		public const int PIX_FMT_VDPAU_MPEG4 = 61;  ///< MPEG4 HW decoding with VDPAU = 0; data[0] contains a vdpau_render_state struct which contains the bitstream of the slices as well as various fields extracted from headers
		public const int PIX_FMT_DXVA2_VLD = 62;    ///< HW decoding through DXVA2 = 0; Picture.data[3] contains a LPDIRECT3DSURFACE9 pointer

		public const int PIX_FMT_RGB444BE = 63;  ///< packed RGB 4:4:4 = 0; 16bpp = 0; (msb)4A 4R 4G 4B(lsb) = 0; big-endian = 0; most significant bits to 0
		public const int PIX_FMT_RGB444LE = 64;  ///< packed RGB 4:4:4 = 0; 16bpp = 0; (msb)4A 4R 4G 4B(lsb) = 0; little-endian = 0; most significant bits to 0
		public const int PIX_FMT_BGR444BE = 65;  ///< packed BGR 4:4:4 = 0; 16bpp = 0; (msb)4A 4B 4G 4R(lsb) = 0; big-endian = 0; most significant bits to 1
		public const int PIX_FMT_BGR444LE = 66;  ///< packed BGR 4:4:4 = 0; 16bpp = 0; (msb)4A 4B 4G 4R(lsb) = 0; little-endian = 0; most significant bits to 1
		...
		public const int AVCHROMA_LOC_LEFT = 1; ///< mpeg2/4, h264 default
