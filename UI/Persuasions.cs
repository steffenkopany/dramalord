...
namespace Dramalord.UI
{
    internal static class Persuasions
    {
        ...
        {
            starter.AddPlayerLine("date_argument_1", PlayerDateArgument, Conversations.NPCDateReply, "{=!}{PERSUADE_ATTEMPT_1}", PlayerOption1, PlayerConsequence1, 100, persuasionOptionDelegate: SetupOption1, clickableConditionDelegate: ClickableOnCondition1);
            starter.AddPlayerLine("date_argument_2", PlayerDateArgument, Conversations.NPCDateReply, "{=!}{PERSUADE_ATTEMPT_2}", PlayerOption2, PlayerConsequence2, 100, persuasionOptionDelegate: SetupOption2, clickableConditionDelegate: ClickableOnCondition2);
            starter.AddPlayerLine("date_argument_3", PlayerDateArgument, Conversations.NPCDateReply, "{=!}{PERSUADE_ATTEMPT_3}", PlayerOption3, PlayerConsequence3, 100, persuasionOptionDelegate: SetupOption3, clickableConditionDelegate: ClickableOnCondition3);
            starter.AddPlayerLine("date_argument_4", PlayerDateArgument, Conversations.NPCDateReply, "{=!}{PERSUADE_ATTEMPT_4}", PlayerOption4, PlayerConsequence4, 100, persuasionOptionDelegate: SetupOption4, clickableConditionDelegate: ClickableOnCondition4);
            starter.AddPlayerLine("date_argument_5", PlayerDateArgument, Conversations.NPCDateReply, "{=!}{PERSUADE_ATTEMPT_5}", PlayerOption5, PlayerConsequence5, 100, persuasionOptionDelegate: SetupOption5, clickableConditionDelegate: ClickableOnCondition5);

            starter.AddPlayerLine("join_argument_1", PlayerJoinArgument, Conversations.NPCJoinReply, "{=!}{PERSUADE_ATTEMPT_1}", PlayerOption1, PlayerConsequence1, 100, persuasionOptionDelegate: SetupOption1, clickableConditionDelegate: ClickableOnCondition1);
            starter.AddPlayerLine("join_argument_2", PlayerJoinArgument, Conversations.NPCJoinReply, "{=!}{PERSUADE_ATTEMPT_2}", PlayerOption2, PlayerConsequence2, 100, persuasionOptionDelegate: SetupOption2, clickableConditionDelegate: ClickableOnCondition2); 
            starter.AddPlayerLine("join_argument_3", PlayerJoinArgument, Conversations.NPCJoinReply, "{=!}{PERSUADE_ATTEMPT_3}", PlayerOption3, PlayerConsequence3, 100, persuasionOptionDelegate: SetupOption3, clickableConditionDelegate: ClickableOnCondition3);
            starter.AddPlayerLine("join_argument_4", PlayerJoinArgument, Conversations.NPCJoinReply, "{=!}{PERSUADE_ATTEMPT_4}", PlayerOption4, PlayerConsequence4, 100, persuasionOptionDelegate: SetupOption4, clickableConditionDelegate: ClickableOnCondition4);
            starter.AddPlayerLine("join_argument_5", PlayerJoinArgument, Conversations.NPCJoinReply, "{=!}{PERSUADE_ATTEMPT_5}", PlayerOption5, PlayerConsequence5, 100, persuasionOptionDelegate: SetupOption5, clickableConditionDelegate: ClickableOnCondition5);

            starter.AddPlayerLine("divorce_argument_1", PlayerDivorceArgument, Conversations.NPCDivorceHusbandReply, "{=!}{PERSUADE_ATTEMPT_1}", PlayerOption1, PlayerConsequence1, 100, persuasionOptionDelegate: SetupOption1, clickableConditionDelegate: ClickableOnCondition1);
            starter.AddPlayerLine("divorce_argument_2", PlayerDivorceArgument, Conversations.NPCDivorceHusbandReply, "{=!}{PERSUADE_ATTEMPT_2}", PlayerOption2, PlayerConsequence2, 100, persuasionOptionDelegate: SetupOption2, clickableConditionDelegate: ClickableOnCondition2);
            starter.AddPlayerLine("divorce_argument_3", PlayerDivorceArgument, Conversations.NPCDivorceHusbandReply, "{=!}{PERSUADE_ATTEMPT_3}", PlayerOption3, PlayerConsequence3, 100, persuasionOptionDelegate: SetupOption3, clickableConditionDelegate: ClickableOnCondition3);
            starter.AddPlayerLine("divorce_argument_4", PlayerDivorceArgument, Conversations.NPCDivorceHusbandReply, "{=!}{PERSUADE_ATTEMPT_4}", PlayerOption4, PlayerConsequence4, 100, persuasionOptionDelegate: SetupOption4, clickableConditionDelegate: ClickableOnCondition4);
            starter.AddPlayerLine("divorce_argument_5", PlayerDivorceArgument, Conversations.NPCDivorceHusbandReply, "{=!}{PERSUADE_ATTEMPT_5}", PlayerOption5, PlayerConsequence5, 100, persuasionOptionDelegate: SetupOption5, clickableConditionDelegate: ClickableOnCondition5);

            starter.AddPlayerLine("marry_argument_1", PlayerMarryArgument, Conversations.NPCMarryReply, "{=!}{PERSUADE_ATTEMPT_1}", PlayerOption1, PlayerConsequence1, 100, persuasionOptionDelegate: SetupOption1, clickableConditionDelegate: ClickableOnCondition1);
            starter.AddPlayerLine("marry_argument_2", PlayerMarryArgument, Conversations.NPCMarryReply, "{=!}{PERSUADE_ATTEMPT_2}", PlayerOption2, PlayerConsequence2, 100, persuasionOptionDelegate: SetupOption2, clickableConditionDelegate: ClickableOnCondition2);
            starter.AddPlayerLine("marry_argument_3", PlayerMarryArgument, Conversations.NPCMarryReply, "{=!}{PERSUADE_ATTEMPT_3}", PlayerOption3, PlayerConsequence3, 100, persuasionOptionDelegate: SetupOption3, clickableConditionDelegate: ClickableOnCondition3);
            starter.AddPlayerLine("marry_argument_4", PlayerMarryArgument, Conversations.NPCMarryReply, "{=!}{PERSUADE_ATTEMPT_4}", PlayerOption4, PlayerConsequence4, 100, persuasionOptionDelegate: SetupOption4, clickableConditionDelegate: ClickableOnCondition4);
            starter.AddPlayerLine("marry_argument_5", PlayerMarryArgument, Conversations.NPCMarryReply, "{=!}{PERSUADE_ATTEMPT_5}", PlayerOption5, PlayerConsequence5, 100, persuasionOptionDelegate: SetupOption5, clickableConditionDelegate: ClickableOnCondition5);
        }
