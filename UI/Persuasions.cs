...
namespace Dramalord.UI
{
    internal static class Persuasions
    {
        ...
        internal static void AddDialogs(CampaignGameStarter starter)
        {
            ...
            starter.AddPlayerLine("divorce_argument_1", PlayerDivorceArgument, Conversations.NPCDivorceReply, "{=!}{PERSUADE_ATTEMPT_1}", PlayerOption1, PlayerConsequence1, 100, persuasionOptionDelegate: SetupOption1, clickableConditionDelegate: ClickableOnCondition1);
            starter.AddPlayerLine("divorce_argument_2", PlayerDivorceArgument, Conversations.NPCDivorceReply, "{=!}{PERSUADE_ATTEMPT_2}", PlayerOption2, PlayerConsequence2, 100, persuasionOptionDelegate: SetupOption2, clickableConditionDelegate: ClickableOnCondition2);
            starter.AddPlayerLine("divorce_argument_3", PlayerDivorceArgument, Conversations.NPCDivorceReply, "{=!}{PERSUADE_ATTEMPT_3}", PlayerOption3, PlayerConsequence3, 100, persuasionOptionDelegate: SetupOption3, clickableConditionDelegate: ClickableOnCondition3);
            starter.AddPlayerLine("divorce_argument_4", PlayerDivorceArgument, Conversations.NPCDivorceReply, "{=!}{PERSUADE_ATTEMPT_4}", PlayerOption4, PlayerConsequence4, 100, persuasionOptionDelegate: SetupOption4, clickableConditionDelegate: ClickableOnCondition4);
            starter.AddPlayerLine("divorce_argument_5", PlayerDivorceArgument, Conversations.NPCDivorceReply, "{=!}{PERSUADE_ATTEMPT_5}", PlayerOption5, PlayerConsequence5, 100, persuasionOptionDelegate: SetupOption5, clickableConditionDelegate: ClickableOnCondition5);
